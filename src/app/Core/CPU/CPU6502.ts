...
export class CPU{
    ...
    private   name:    string  =   '';      // instruction name
     ...
     */
    private write(a: number, d: number): void{
        this.Bus.write(a, d);
    }
    ...
    public clock(): void{
        ...
        if (this.cycles != 0){
            ...
            this.name = this.instructions[this.pch][this.pcl].name;
